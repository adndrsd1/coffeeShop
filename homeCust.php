    ...
    <div class="page">
        ...
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                ...
                <a href="profile.html" class="Lightbtn" id="profile-button"><i class="fas fa-user"></i>Profile</a>
        ...
        <section class="home" id="home">
            <div class="homeBox1">
                <div class="home-text">
                    ...
                    <a href="delivery.html" class="btn">Grab Now</a>
                </div>
                <div class="home-img">
        ...
        <section class="promo" id="promo">
            ...
            <div class="promo-container">
                <div class="box">
                    ...
                    <a href="delivery.html" class="btn">Order Now</a>
                </div>
