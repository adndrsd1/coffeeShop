                    ...
                    ?>
                        <tr>
                            ...
                            <td class="flex flex-row h-[150px] border-0 justify-center">
                                <form action="manageMenu.php" method="get">
                                    <button data-modal-target="update-modal" data-modal-toggle="update-modal" class="block text-black bg-[#D1BB9E] hover:bg-[#A79277] focus:outline-none font-small rounded-full text-sm px-3 py-2.5 text-center" type="button">
                                        Update
                                    </button>

                                    <!-- Main modal for update menu -->
                                    <div id="update-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative p-4 w-full max-w-md max-h-full">
                                            ...
                                            <div class="relative bg-[#D1BB9E] rounded-lg shadow dark:bg-[#D1BB9E]">
                                                ...
                                                <!-- Modal body -->
                                                <form action="manageMenu.php" class="p-4 md:p-5" method="get" enctype="multipart/form-data">
                                                    <div class="grid gap-4 mb-2 grid-cols-2">
                                                        <div>
                                                        ...
                                                        <div class="col-span-2 sm:col-span-1">
                                                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
                                                            <select id="category" name="kategori" value="<?php echo $row['kategori'] ?>" class="bg-white border border-gray-300 text-[#74512D] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                                                <option selected="">Select category</option>
                                                                <option value="Hot Coffee">Hot Coffee</option>
                                                                <option value="Iced Coffee">Iced Coffee</option>
                                                                <option value="Pastries">Pastries</option>
                                                        ...
                                                        <div class="col-span-2">
                                                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Gambar</label>
                                                            <input type="image" name="gambar" id="gambar" value="<?php echo $row['gambar'] ?>" class="bg-white border border-gray-300 text-[#74512D] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required="">
                                                        </div>
                                                        <div class="col-span-2">
                                                            <label for="namaMenu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Menu</label>
                                                    ...
                                                    <div class="flex justify-center items-center">
                                                        <button type="submit" name="submit" class="text-[#74512D] inline-flex items-center bg-[#FFF2E1] hover:bg-[#A79277] font-medium rounded-full text-sm px-3 py-2.5 text-center">
                                                            Update menu
                                                        </button>
                                                    </div>
                                                </form>
