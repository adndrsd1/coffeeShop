                        ...
                        <form action="menuController.php" class="p-4 md:p-5" method="post" enctype="multipart/form-data">
                            <div class="grid gap-4 mb-2 grid-cols-2">
                                <div class="col-span-2 sm:col-span-1">
                                    ...
                                    <select id="category" name="kategori" value="kategori" class="bg-white border border-gray-300 text-[#74512D] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input type="file" name="gambar" id="gambar" value="gambar" class="bg-white border border-gray-300 text-[#74512D] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" required="">
                                </div>
                                <div class="col-span-2">
                                    <label for="namaMenu" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama Menu</label>
                                    <input type="text" name="namaMenu" id="namaMenu" value="namaMenu" class="bg-white border border-gray-300 text-[#74512D] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Nama Menu" required="">
                                </div>
                                <div class="col-span-2">
                                    <label for="harga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga</label>
                                    <input type="text" name="harga" id="harga" value="harga" class="bg-white border border-gray-300 text-[#74512D] text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5" placeholder="Rp 20.000" required="">
                                </div>
                            </div>
                        ...
                        <tr>
                            ...
                            <td class="flex flex-row h-[150px] border-0 justify-center">
                                <form action="updateMenu.php" method="get">
                                    ...
                                    <button data-modal-target="update-modal" data-modal-toggle="update-modal" class="block text-white bg-[#D1BB9E] hover:bg-blue-800 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center dark:bg-[#D1BB9E] dark:hover:bg-[#A79277] mb-2">Update</button>
                                </form>
